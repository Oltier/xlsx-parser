 ...
 */
ExcelParser.prototype.extractFiles = function(filepath, sheets, callback) {
    var files = {
        strings: {},
        book: {},
        sheets: []
 ...
 * @param {Function} callback
 */
ExcelParser.prototype.parse = function(filepath, opts, callback) {
    var _this = this;
    this.extractFiles(filepath, opts.sheets, function(err, result) {
        if (err) {
            return callback(err);
        }

        _this.extractData(result, callback);
    });
};
